package com.pixeltrice.controller;
...
import com.pixeltrice.service.ImageGalleryService;
...
public class ImageGalleryController {
	...
	//pour stocker les nouveaux détails de l’image dans la base de données MySQL
	...
	public @ResponseBody ResponseEntity<?> createProduct(@RequestParam("name") String name,
		...
		try {
			...
			//converti l’image dans le tableau d’octets et stocké tous les détails liés à l’image tels que le nom, la description, les images, etc. dans la base de données MySQL.
	...
	//Cette API est utilisée pour récupérer la forme byte[] de l’image particulière de la base de données et la convertir au format jpeg, png, jpg ou gif à afficher dans le navigateur
...
//récupère les détails de l’image dans la base de données en fonction de l’id de l’image et s’affiche dans les détails de l’image.html
...
//utilisée pour afficher la liste des produits avec leurs détails dans la page images.html
